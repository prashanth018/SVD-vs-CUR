...
csvfile = open('C:\Users\Nishanth\Downloads\Book.csv')
...
error = frob(arr,k)
print error
#np.savetxt(r'C:\Users\Prasanth\Desktop\original_cur.csv',np.asarray(arr),delimiter=" ")
#np.savetxt(r'C:\Users\Prasanth\Desktop\computed_cur.csv',k,delimiter=" ")
print "Done..!"
csvfile.close()